...
# Add and adjust plot
plt.figure(figsize=(10, 6))
plt.plot(df_2025_filtered.index, df_2025_filtered['CAD'], label='EUR/CAD Jan-Apr 2025', color='green')
plt.title('Actual EUR/CAD Exchange Rate from January to April 2025')
plt.xlabel('Date')
plt.ylabel('EUR/CAD')
plt.grid(True)
plt.legend()
